...
export const Clima = ({nombre="buenos aires"}) => {
    ...
    const {data,status}=  useFetch(`https://api.openweathermap.org/data/2.5/weather?q=${nombre}&appid=e7ae586051eb4b986d35b62bf6096e01`)
